...
def validate_trip_details(state: Dict[str, Any], llm: Any) -> Dict[str, Any]:
    ...
    2. Start date is not in the past (today is {datetime.now().strftime("%Y-%m-%d")})
    3. Origin and destination are different valid locations
    4. Number of travelers is reasonable (1-10)
    5. Budget is realistic for the trip duration and number of travelers
